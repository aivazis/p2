...
class Priority:
    ...
    # ordering: provide the base definitions; {functools.total_ordering} will do the rest
    def __eq__(self, other):
        # leverage tuple ordering
...
# build a counter; it gets used to collate the categories automatically so i can adjust the
# list of categories without having to worry about the numbering
